...
// -----------------Cult Events -----------------
import {abhivyakti, acrylicink,bollyflix,dubsmash,englishexetempore,euphony,groupdance,heelsandcaps,hindiextempore,jam,kavyansh,mastermind,meme,rangsmash,shortmoviemaking,snapshot,solodance,stew,themimic,facemeup} from '../../img/Events/index'

// -----------------Tech Events -----------------
import {BSchools,Cadastrophe,codex,hackers,kaggle,technocrates} from '../../img/Events/index';


//---------------- sports Events  -------------
import {athletics,badminton,bodybuilding,chess,download,KhoKho,soccer,summer1,tabletennis,vollyball} from '../../img/Events/index';
...
const total_events = [
  ...
  [
    ...
    },
    {
      id: 6,
      name: "THE MIMIC",
      description: "This event centres around Mimicry. Show your artwork and make the audience amused. The artists will get five minutes to perform. Stars from the movies are featured. Idea, originality, makeup, music, and overall impact are the criteria by which mono acting is evaluated.",
      img: themimic,
    },
    {
      id: 7,
    ...
    },
    {
      id: 12,
      name: "MASTERMIND",
      description: "Top-secret quizzes identify the world most brilliant brains. The first set of questions will focus on movies andother forms of pop culture. Afterwards, we'll choose the best five squads. The top three squads will be decided by answering science-based questions in the second round. Events both far and near will serve as the inspiration for the questions.",
      img: mastermind,
    },
    {
      id: 13,
      name: "HEELS AND CAPES",
      description: "Bring it on with the Fashion show. The rounds include ramp walk, skill round as well as questions from the judges. The first lap of the ramp walk has no overarching theme. Props are not  provided for the performers. The winners of the last round are Mr. and Miss INTELLIA",
      img: heelsandcaps,
    },
    {
      id: 14,
      name: "SNAPSHOT",
      description: "Photography is an art from the very soul. A photograph immortalises a fleeting moment that has already passed. Participants in an online  photography competition are tasked  with producing pictures that respond  to a certain subject",
      img: snapshot,
    },
    {
      id: 15,
      name: "EUPHONY",
      description: "Stretch the limits of your voice in this singing event.  Lift your voice to the stars and sing. Play for three minutes, maximum. We 'll be taking a look at how  well the crowd reacts to your music as well as itsz range, clarity, and rhythm.",
      img: euphony,
    },
    {
      id: 16,
      name: "KAVYANSH",
      description: "A poetry recitation awaits your presence, so come and be delighted!",
      img: kavyansh,
    },
    {
      id: 17,
      name: "STEW",
      description: "This is an informal oratory event that  puts a premium on quick thinking and reflexes. The format of competitions is determined by judges. Plusses for  being on message, being funny, being original, and being coherent.",
      img: stew,
    },
    {
      id: 18,
      name: "JAM",
      description: "Participating in Just a Minute (JAM) challenges students to go beyond the box when it comes to their methods of expression. Students may hone their interpersonal communication skills by competing in this competition",
      img: jam,
    },
    {
      id: 19,
      name: "DUBSMASH",
      description: "Your dub is wanted. Bring out your drama, IITJ Janta.After all, you are the centre of your own universe.",
      img: dubsmash,
    },
    {
      id: 20,
      name: "SHORT MOVIE-MAKING",
      description: "This short movie making event is your opportunity to show off your skills and ingenuity. Team up, be creative, and get ready to have a blast making a movie that will be remembered for years to come.",
      img: shortmoviemaking,
    },
    {
      id: 21,
      name: "DEPARTMENTAL EXHIBITION",
      description: "Departmental Exhibitions will be held respectively for all 15 departments in the institute. It would help students to get to know about other departments also, with the help of Departmental Exhibitions, each department can showcase their departmental activities, paper presentations and model based showcasing of core knowledge",
      img: bg7,
    },
  ],
];
          ...
          {total_events[activeTab].map((item) => (
            ...
            >
              <div className="basis-full md:basis-1/2">
                <p className="intellia_heading_about  text-3xl md:text-5xl">{item.name}</p>
                <p className="py-3 px-2 footer_license_text  text-sm md:text-lg ">
                  {item.description}
                </p>
              ...
              <div className="basis-full md:basis-1/2">
                <img src={item.img} alt="" className="object-cover h-52 w-96" />
              </div>
            </div>
          ))}
        </div>
